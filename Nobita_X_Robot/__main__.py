...
✪ 𝐓ʜᴇ 𝐌ᴏsᴛ 𝐏ᴏᴡᴇʀғᴜʟ 𝐓ᴇʟᴇɢʀᴀᴍ 𝐁ᴏᴛ 𝐅ᴏʀ

✯ 彡[𝐆ʀᴏᴜᴩ 𝐌ᴀɴᴀɢᴇᴍᴇɴᴛ]彡
✯ 彡[𝐂ʜᴀᴛ 𝐁ᴏᴛ]彡
...
buttons = [
    [
        InlineKeyboardButton(
            text="☆ 𝐀𝐝𝐝 𝐦𝐞 𝐲𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩 ☆",
            url=f"https://t.me/{dispatcher.bot.username}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="🚀 𝐇ᴇʟᴘ & 𝐂ᴍᴅs 🚀️‍🔥", callback_data="help_back"),
        InlineKeyboardButton(text="✨ 𝐌ᴜsɪᴄ ✨", callback_data="Music_"),
    ],
    [
        InlineKeyboardButton(text="🌹s.𝐒ᴜᴩᴩᴏʀᴛ 𝐂ʜᴀᴛ🌹", url=f"https://t.me/{SUPPORT_CHAT}"),
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            if args[0].lower() == "help":
                ...
                send_help(
                    ...
                    InlineKeyboardMarkup(
                        [[InlineKeyboardButton(text="✯ 𝐁αϲк ✯", callback_data="help_back")]]
                    ),
                )
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAx0CcD86dQACfgpkmRgWmbm1feDrKJh3KIcIAAHEDVsAApgHAAI4jAABVTjSFPkb2_jeLwQ")
            x.delete()
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="✯ 𝐁αϲк ✯", callback_data="rana_back"),
                    ],
                ]
            ),
        )
    elif query.data == "rana_back":
        first_name = update.effective_user.first_name 
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), (START_IMG), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
...
""",
            ...
            [
                InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="✯ 𝐁αϲк ✯", callback_data="nobi_back"),
                    ],
                ]
           ),
        )
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="✯ 𝐁αϲк ✯", callback_data="Music_"),
                    ]
                ]
            ),
        )
